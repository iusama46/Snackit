...
class _Checkout3ViewState extends State<Checkout3View> {
  ...
  dynamic payRazorNow(
    ...
    print(
        'Total Price ${basketProvider.checkoutCalculationHelper.totalPrice.toString()}');
    print(
        'Two Decimal ${Utils.getPriceTwoDecimal(basketProvider.checkoutCalculationHelper.totalPrice.toString())}');
    print(
        'Double ${double.parse(Utils.getPriceTwoDecimal(basketProvider.checkoutCalculationHelper.totalPrice.toString()))}');
