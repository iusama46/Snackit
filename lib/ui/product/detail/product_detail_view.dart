...
import 'package:flutterrestaurant/provider/basket/helper/checkout_calculation_helper.dart';
      ...
      return Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Visibility(
              visible: widget.productDetail.productDetail.data
                  .highlightInformation =='null' ,
              child: Container(
                margin: const EdgeInsets.only(
