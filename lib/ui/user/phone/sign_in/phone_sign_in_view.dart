                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _SendButtonWidget(
                            provider: provider,
                            nameController: nameController,
                            phoneControllerUpdate: phoneController,
...
class _SendButtonWidget extends StatefulWidget {
  const _SendButtonWidget(
      ...
      @required this.phoneControllerUpdate,
      @required this.phoneSignInSelected});
  final UserProvider provider;
  final TextEditingController nameController;
  final TextEditingController phoneControllerUpdate;
  final Function phoneSignInSelected;
...
class __SendButtonWidgetState extends State<_SendButtonWidget> {
  ...
  Future<String> verifyPhone() async {
    widget.phoneControllerUpdate.text='+966'+widget.phoneControllerUpdate.text.substring(1);
    ...
    return Container(
      ...
      child: PSButtonWidget(
        ...
        onPressed: () async {
          ...
          } else if (widget.phoneControllerUpdate.text.isEmpty) {
            callWarningDialog(context,
